...
conn=DriverManager.getConnection("jdbc:odbc:USA");

Statement stmt = conn.createStatement();

 String sql1;
 sql1="SELECT  email FROM senior WHERE email = '"+smail+"'";
...
{
    String sql;
    sql = "SELECT username FROM profile where email='"+smail+"'";
     ResultSet rs2 = stmt.executeQuery(sql);

    // Extract data from result set
    while(rs2.next()){
       //Retrieve by column name
     profile_id  = rs2.getString("username");
    }
